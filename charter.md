This is a copy of the charter from https://ebpf.foundation/charter/ . It is not
...
Linux kernel, eBPF runtimes, and the eBPF’s Landscape Projects. There can be
at most two representatives on the BSC employed by the same company or by
Related Companies.
...
be responsible for:
   ...
   #. coordinating collaboration across the eBPF ecosystem,
   including the development of an overall technical vision and eBPF Project
   Landscape for the community;

   #. identifying and facilitating areas of collaboration within the Technical
   Project community and with adjacent open source communities (including but
   not limited eBPF Landscape Projects) to support eBPF’s use and adoption,
   such as communities focused on compilers, kernels, and debuggers; and

   #. making recommendations to the DAC of resource priorities for eBPF’s
   success.
...
#. Definitions:
   ...
   #. “Subsidiaries” means any entity in which a Member owns, directly or
